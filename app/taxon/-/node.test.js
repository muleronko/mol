...
(function ($) {
    var $mol_app_taxon_demo = (function (_super) {
        ...
        $mol_app_taxon_demo.prototype.sub = function () {
            return [].concat(this.App());
        };
        $mol_app_taxon_demo.prototype.App = function () {
            var _this = this;
            return (function (obj) {
                obj.hierarchy_field = function () { return "name"; };
                obj.hierarchy = function () { return _this.hierarchy(); };
                obj.record = function (path) { return _this.record(path); };
                return obj;
