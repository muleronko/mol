    ...
    (function ($$) {
        var $mol_app_lamps = (function (_super) {
            ...
            $mol_app_lamps.prototype.lamps = function () {
                return this.lamps_all().filter($.$mol_match_text(this.filter(), function (lamp) { return Object.keys(lamp).map(function (field) { return lamp[field]; }); }));
            };
...
(function ($) {
    var $mol_app_lamps_demo = (function (_super) {
        ...
        $mol_app_lamps_demo.prototype.sub = function () {
            return [].concat(this.App());
        };
        $mol_app_lamps_demo.prototype.App = function () {
            return (function (obj) {
                return obj;
