namespace $ { export class $mol_app_studio extends $mol_book {
	...
	preview_title() {
		return $mol_locale.text( this.locale_contexts() , "preview_title" )
	}
	...
	editor_title() {
		return $mol_locale.text( this.locale_contexts() , "editor_title" )
	}
	...
	source_title() {
		return $mol_locale.text( this.locale_contexts() , "source_title" )
	}
