namespace $ { export class $mol_app_studio_field extends $mol_expander {
	...
	/// type_hint @ \Type...
	type_hint() {
		return $mol_locale.text( this.locale_contexts() , "type_hint" )
	}
	...
	/// object_hint @ \Class...
	object_hint() {
		return $mol_locale.text( this.locale_contexts() , "object_hint" )
	}
	...
	/// bind_hint @ \Property..
	bind_hint() {
		return $mol_locale.text( this.locale_contexts() , "bind_hint" )
	}
	...
	prop_add_label() {
		return $mol_locale.text( this.locale_contexts() , "prop_add_label" )
	}
	...
	/// add_hint @ \Add item..
	add_hint() {
		return $mol_locale.text( this.locale_contexts() , "add_hint" )
	}
	...
	add_pair_hint() {
		return $mol_locale.text( this.locale_contexts() , "add_pair_hint" )
	}
	...
	add_over_hint() {
		return $mol_locale.text( this.locale_contexts() , "add_over_hint" )
	}
